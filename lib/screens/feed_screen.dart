              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const StatCard(title: 'Calories', value: '850', subtitle: 'of 1200 kcal', icon: Icons.local_fire_department),
                        const SizedBox(width: 16),
                        const StatCard(title: 'Time Logged', value: '1h 45m', subtitle: "Today's total", icon: Icons.access_time_filled),
                      ],
                    ),
